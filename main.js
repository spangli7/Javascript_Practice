...
function getServerData(url) {
    ...
    return fetch(url, fetchOptions).then(                                              //server 
...
function createBtnGroup() {                                                                                //  create Group
    let group = createAnyElement("div", { class: "btn btn-group" });
    let infoBtn = createAnyElement("button", { class: "btn btn-info", onclick: "setRow(this)" });                                      // create  button
    ...
    delBtn.innerHTML = '<i class="fa fa-trash-o" aria-hidden="true"></i>'                                  // create  icon
